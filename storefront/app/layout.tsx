...
export const metadata: Metadata = {
  title: {
    default: 'Hyde & Co. — Premium Leather Goods',
    template: '%s | Hyde & Co.',
  },
  description: 'Full-grain leather jackets and bags handcrafted for those who refuse to settle. Built to age, built to last.',
}
